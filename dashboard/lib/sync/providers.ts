...
// Mirrors the sync.provider enum in the DB (migration 0021 added dub/sendblue/monday, 0050 slack).
export type Provider = "ghl" | "close" | "stripe" | "nmi" | "meta" | "dub" | "sendblue" | "monday" | "slack";
