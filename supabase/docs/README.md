...
| [core.app_user](core.app_user.md) | 10 | Dashboard login accounts (scrypt password hashes). Verified server-side only; no client access. rep_id links a login to their sales.rep record so forms pre-fill. | BASE TABLE |
